...
6) Dans la console déplacez vous dans le répertoire client puis saisissez la commande '''npm install -g @angular/cli@17'''
7) Saisissez la commande '''npm install'''
8) Enfin lancez le serveur angular : '''ng serve'''
